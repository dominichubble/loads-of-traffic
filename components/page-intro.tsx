    ...
    <header className={cn("relative", className)}>
      ...
      <div className="page-split relative">
        ...
        <div className="page-rise page-rise-delay-1 min-w-0 space-y-5 md:pt-1">
          <h2 className="text-xl font-medium leading-snug text-balance break-words text-white md:text-2xl xl:text-[1.85rem] xl:leading-snug">
            {headline}
          </h2>
          <p className="max-w-[62ch] text-sm leading-relaxed text-pretty break-words text-white md:text-base md:leading-relaxed lg:text-lg">
            {description}
          </p>
        </div>
      </div>
