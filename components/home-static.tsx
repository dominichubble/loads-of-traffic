            ...
            >
              ...
              <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-12">
                <div className="flex items-center justify-between border-b border-white/15 pb-4">
                  <span className="page-kicker text-white/65">Capability</span>
                ...
                <TransitionLink
                  ...
                  className="mt-7 inline-flex min-h-12 w-fit items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-primary shadow-lg"
                >
                  Explore service
