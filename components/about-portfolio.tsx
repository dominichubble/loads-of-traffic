...
const AboutPortfolio = () => {
  return (
    <AboutSection>
      <div className="rounded-[2rem] border border-white/15 bg-accent p-7 shadow-[0_28px_80px_rgba(0,0,79,0.18)] sm:p-10 sm:py-12 lg:p-14">
        ...
        <div className="space-y-10 xl:space-y-14">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-[56ch] text-sm font-medium leading-relaxed text-white md:text-lg">
